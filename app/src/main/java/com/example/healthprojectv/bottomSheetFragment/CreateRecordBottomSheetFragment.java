...
public class CreateRecordBottomSheetFragment extends BottomSheetDialogFragment {
...
/*
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, RecordMain recordMain) {
        this.taskId = taskId;
        this.isEdit = isEdit;
